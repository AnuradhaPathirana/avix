            ...
            <div className="container">
                <div className="contact-wrapper">
                    ...
                    <div className="contact-info-panel">
                        ...
                        <div className="contact-group">
                            <h4>CONTACT</h4>
                            <p className="contact-link"><a href="tel:+1007775558888">+1 (00) 777 555 - 8888</a></p>
                            <p className="contact-link"><a href="mailto:hello@avix.com">hello@avix.com</a></p>
                        </div>
                ...
                <div className="footer-bottom">
                    <p>&copy; 2026 <a href="https://andryanweb.com" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>andryanweb</a>. All rights reserved.</p>
